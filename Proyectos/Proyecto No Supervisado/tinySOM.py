...
TDQM_LOADING_BAR_FLAG = True
try:
    import tqdm
except:
    print('tqdm package missing, no progress bar on SOM training will be displayed.')
    TDQM_LOADING_BAR_FLAG = False
